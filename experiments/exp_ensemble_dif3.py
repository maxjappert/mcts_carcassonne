...
for tree_policy in tree_policies.keys():
    for num_ensemble_iterations in options:
        ...
        value1 = ['--p1',  f'{tree_policy}', '--p2',  f'{tree_policy}', '--p1trainingiterations', f'{50}', '--p2trainingiterations', f'{1000}', '--p1explorationterm', f'{tree_policies[tree_policy]}', '--p2explorationterm', f'{tree_policies[tree_policy]}', '--p1ensembleiterations', f'{num_ensemble_iterations}']
        value2 = ['--p1',  f'{tree_policy}', '--p2',  f'{tree_policy}', '--p1trainingiterations', f'{1000}', '--p2trainingiterations', f'{50}', '--p1explorationterm', f'{tree_policies[tree_policy]}', '--p2explorationterm', f'{tree_policies[tree_policy]}', '--p2ensembleiterations', f'{num_ensemble_iterations}']
