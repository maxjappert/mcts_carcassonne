...
for type in tree_policies.keys():
    for delta in deltas:
        ...
        value1 = ['--p1',  f'{type}', '--p2', f'{type}', '--p1trainingiterations', '1000', '--p2trainingiterations', '1000', '--p1explorationterm', f'{tree_policies[type]}', '--p2explorationterm', f'{tree_policies[type]}', '--p1backpropdelta', f'{delta}']
        value2 = ['--p1',  f'{type}', '--p2', f'{type}', '--p1trainingiterations', '1000', '--p2trainingiterations', '1000', '--p1explorationterm', f'{tree_policies[type]}', '--p2explorationterm', f'{tree_policies[type]}', '--p2backpropdelta', f'{delta}']
