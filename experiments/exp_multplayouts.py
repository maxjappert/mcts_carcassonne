...
for tree_policy in tree_policies.keys():
    for num_playouts in options:
        key1 = f'{tree_policy}-{num_playouts}-1'
        key2 = f'{tree_policy}-{num_playouts}-2'

        value1 = ['--p1',  f'{tree_policy}', '--p2',  f'{tree_policy}', '--p1trainingiterations', '1000', '--p2trainingiterations', '1000', '--p1explorationterm', f'{tree_policies[tree_policy]}', '--p2explorationterm', f'{tree_policies[tree_policy]}', '--p1numplayouts', f'{num_playouts}']
        value2 = ['--p1',  f'{tree_policy}', '--p2',  f'{tree_policy}', '--p1trainingiterations', '1000', '--p2trainingiterations', '1000', '--p1explorationterm', f'{tree_policies[tree_policy]}', '--p2explorationterm', f'{tree_policies[tree_policy]}', '--p2numplayouts', f'{num_playouts}']
