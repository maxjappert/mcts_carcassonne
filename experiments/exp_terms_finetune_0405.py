...
terms_to_test = [i*0.2 for i in range(0, 50)]
...
for i in terms_to_test:
    for j in terms_to_test:
        if i != j:
            ...
            value4 = ['--p1',  'boltzmann', '--p2', 'boltzmann', '--p1trainingiterations', '500', '--p2trainingiterations', '500', '--p1explorationterm', str(j), '--p2explorationterm', str(i)]
            value5 = ['--p1',  'uct-tuned', '--p2', 'uct-tuned', '--p1trainingiterations', '500', '--p2trainingiterations', '500', '--p1explorationterm', str(i), '--p2explorationterm', str(j)]
            value6 = ['--p1',  'uct-tuned', '--p2', 'uct-tuned', '--p1trainingiterations', '500', '--p2trainingiterations', '500', '--p1explorationterm', str(j), '--p2explorationterm', str(i)]
