public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0) {
            ...
            player1 = new MCTSPlayer(stateSpace, 1, 4f, 50, 1455086940, 0.5f, 0, "uct", "random", 0, false, 5, 1, false);
            player2 = new MCTSPlayer(stateSpace, 2, 4f, 100, -1, 0.5f, 0, "uct", "random", 0, false, 1, 1, false);
