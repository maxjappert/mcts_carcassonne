public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0) {
            player1 = new MCTSPlayer(stateSpace, 1, 7f, 100, -1, 0.5f, 0, "uct", false, 0f, false, 1, 1, false);
            player2 = new MCTSPlayer(stateSpace, 2, 7f, 100, -1, 0.5f, 0, "uct", false, 0f, false, 1, 1, true);
