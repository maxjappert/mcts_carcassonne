...
public class RandomPlayer extends Player {
     ...
     */
    @Override
    public int[] decideOnNextMove(GameState state, GameStateSpace stateSpace, Tile tile, List<Tile> deck) {
        ...
        List<Integer> meeplePlacements = stateSpace.legalMeeples(state, tile, action, playerID);
